class DashboardsController < ApplicationController
  ...
  def user_profile_data
    data = {"user":{"id":2,"name":"anjal","balance":0,"points":420},"kuris":[{"id":0,"contribution":1000,"prize":0,"truthTable":{"periods":6,"participants":[{"name":"julu","statuses":["RECEIVED","PENDING","PENDING","PENDING","PENDING","PENDING"]},{"name":"hashif","statuses":["COMPLETED","RECEIVED","RECEIVED","RECEIVED","PENDING","PENDING"]},{"name":"anjal","statuses":["COMPLETED","PENDING","RECEIVED","RECEIVED","PENDING","PENDING"]},{"name":"nihal","statuses":["COMPLETED","PENDING","PENDING","PENDING","PENDING","PENDING"]},{"name":"john","statuses":["RECEIVED","PENDING","PENDING","PENDING","PENDING","PENDING"]},{"name":"amal","statuses":["COMPLETED","PENDING","PENDING","PENDING","PENDING","PENDING"]}]}}]}.with_indifferent_access
    render json: data
  end
